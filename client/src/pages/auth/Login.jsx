        ...
        <div className="flex justify-center items-center min-h-screen bg-background relative overflow-hidden">
            ...
            >
                <div className="text-center mb-8">
                    ...
                    {/* Better approach: Use conditional rendering like Navbar if possible, or just standard text color inheriting */}
                ...
                <p className="mt-8 text-center text-text-muted text-sm">
                    Don't have an account? <span className="text-primary hover:text-primary/80 cursor-pointer font-medium transition-colors" onClick={() => navigate('/register')}>Create Account</span>
                </p>
            </motion.div>
        </div>
    );
